...
instructions = ['add', 'sub', 'div', 'div2', 'mult', 'mult2', 'and', 'or', 'goto', 'store', 'jz', 'halt', 'wb', 'ww']
...
def encode_instruction(inst, ops):
   if inst == 'add' or inst == 'sub' or inst == 'div' or inst == 'div2' or inst == 'mult' or inst == 'mult2' or inst == 'and' or inst == 'or' or inst == 'store' or inst == 'jz':
...
def resolve_names():
   ...
   for line in lines_bin:
      for i in range(0, len(line)):
         if is_name(line[i]):
            if line[i-1] == instruction_set['add'] or line[i-1] == instruction_set['sub'] or line[i-1] == instruction_set['div'] or line[i-1] == instruction_set['div2'] or line[i-1] == instruction_set['mult'] or line[i-1] == instruction_set['mult2'] or line[i-1] == instruction_set['and'] or line[i-1] == instruction_set['or'] or line[i-1] == instruction_set['store']:
